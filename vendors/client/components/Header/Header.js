...
import {logoutUrl, getUrlPath} from '../../config/yysso';
  ...
  logout = (e) => {
    ...
    this.props.logoutActions().then((res) => {
      if (res.payload.data.errcode == 0) {
        ...
        // window.location.href = 'https://euc.yonyoucloud.com/cas/logout?SAMLRequest=true&service=http://localhost:3000';
        window.location.href = logoutUrl + getUrlPath();
      } else {
